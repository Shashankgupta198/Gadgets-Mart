                    ...
                    <div class="span9">
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <div class="row">	  
                                    <div id="gallery" class="span3">
                                        <a href="themes/images/products/large/f1.jpg" title="<?php echo $row["productname"]; ?>">
                                            <img src=""<?php echo $img_path; ?> style="width:100%" alt=""/>
                                        </a>
                            ...
                            <div class="span6">
                                ...
                                ?>  </h3>
                                <small>- <?php echo $row["productid"]; ?></small>
                                <hr class="soft"/>
