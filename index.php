<?php require_once("api/OpenConnection.php"); ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Gadgets Mart</title>
        ...
        <div id="carouselBlk">
            <div id="myCarousel" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <div class="item">
                        <div class="container">
                            <a href="register.php?photoid=<?php echo $row["photoid"]; ?>"><img src = "<?php echo $img_path; ?>" width = "1200px" height = "200px" alt = ""/></a>
                            <div class="carousel-caption">
                                <h4>Second Thumbnail label</h4>
                                <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                            </div>
                            ...
                            <div class="thumbnail">
                                ...
                                if ($result && mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        ?>
                                        <img src = "<?php echo $img_path; ?>" width = "160px" height = "160px" alt = "">
                                        <div class="caption">
                                            <h5><?php echo $row["productname"]; ?></h5>
                                            <h4 style="text-align:center"><a class="btn" href="product_details.html"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#"><?php echo $row["price"]; ?></a></h4>
                                        </div>
                                    </div><br/>
                                    <?php
                                }
                                            ...
                                            <ul class="thumbnails">
                                                ...
                                                if ($result && mysqli_num_rows($result) > 0) {
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        ?></h5>
                                                                    <h4><a class = "btn" href ="productdetail.php">VIEW</a> <span class = "pull-right">Rs.<?php echo $row["price"];
                                                        ?></span></h4>
                                                                </div>
                                                            </div>
                                                        </li>
